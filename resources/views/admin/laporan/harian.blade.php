        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Daftar transaksi berdasarkan tanggal:
                        <strong>{{ $tanggal }}</strong></p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- Filter tanggal --}}
                    <form method="GET" action="{{ route('admin.laporan.harian') }}" class="row g-3 mb-3">
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <a href="{{ route('laporan.harian.pdf', ['tanggal' => request('tanggal', $tanggal)]) }}"
