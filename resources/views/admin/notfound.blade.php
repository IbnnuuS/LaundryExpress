...
<head>
    ...
    <title>404 - Laundry Express</title>
    ...
    <link rel="stylesheet" crossorigin href="{{ asset('template/assets') }}/compiled/css/error.css">
</head>
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('template/assets') }}/compiled/svg/error-404.svg"
                        alt="Not Found">
                    <h1 class="error-title">Mau ngapain?</h1>
